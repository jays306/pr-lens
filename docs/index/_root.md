...
Caching → backend-cache.md
Browser extension UI, overlay, content script → extension.md
...
backend-cache → docs/index/backend-cache.md → backend/cache/
extension → docs/index/extension.md → extension/src/, extension/public/, extension/build.ts, extension/manifest.json
